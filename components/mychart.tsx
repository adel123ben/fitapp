...
// import the data
import mockData, {heartRateData, runningData}  from "@/data/motData.json"
  ...
  return (
    <div className="chart-wrapper mx-auto flex max-w-6xl flex-col flex-wrap items-start justify-center gap-6 p-6 sm:flex-row sm:p-8">
      <div className="grid w-full gap-6 sm:grid-cols-2 lg:max-w-[22rem] lg:grid-cols-1 xl:max-w-[25rem]">
        ...
        <Card x-chunk="A bar chart showing the number of steps you have walked in the past 7 days." className="lg:max-w-md">
      <CardHeader className="space-y-0 pb-2">
        <CardDescription>Today</CardDescription>
        <CardTitle className="text-4xl tabular-nums">
          {mockData.stepsData.reduce((acc, item) => acc + item.steps, 0).toLocaleString()}{" "}
          <span className="font-sans text-sm font-normal tracking-normal text-muted-foreground">
            steps
          </span>
        </CardTitle>
      ...
      <CardContent>
        ...
        >
          ...
          >
                  ...
                  return (
                    <div className="rounded-lg border bg-background p-2 shadow-sm">
                      <div className="flex flex-col">
                        <span className="font-bold">{new Date(payload[0].payload.date).toLocaleDateString()}</span>
                        <span>Steps: {payload[0].value}</span>
                      </div>
                    </div>
                  );
                }
            ...
            />
            <ReferenceLine
              y={12000} // Exemple de ligne de référence pour 12000 étapes
              stroke="hsl(var(--muted-foreground))"
              strokeDasharray="3 3"
            >
              <Label position="insideTopLeft" value="Target" offset={10} />
            </ReferenceLine>
          </BarChart>
        </ChartContainer>
      </CardContent>
...
<Card
  x-chunk="A bar chart showing the running distance for the past 7 days."
  className="max-w-xs"
>
  <CardHeader className="p-4 pb-0">
    <CardTitle>Running Distance</CardTitle>
    <CardDescription>
      Over the last 7 days, your average running distance was 5.9 kilometers per day.
    </CardDescription>
  </CardHeader>
  <CardContent className="flex flex-row items-baseline gap-4 p-4 pt-0">
    <div className="flex items-baseline gap-1 text-3xl font-bold tabular-nums leading-none">
